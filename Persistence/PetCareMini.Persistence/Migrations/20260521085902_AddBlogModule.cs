        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalPosts = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BlogAuthorProfiles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BlogAuthorProfiles_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BlogAuthorProfiles_UserId",
                table: "BlogAuthorProfiles",
                column: "UserId",
                unique: true);
